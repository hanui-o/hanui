...
import { fetchRegistry, getSourceBaseUrl } from '../utils/registry.js';
 ...
 * Add Command
 *
 * Adds HANUI Vue components to the user's project
 * Usage: npx @hanui/vue add <component-name>
 */
