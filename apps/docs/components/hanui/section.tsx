...
/**
 * Note: Global styles for KRDS Section Spacing System should be added to global CSS.
 * This component no longer injects styles to avoid styled-jsx dependency.
 *
 * Add the following CSS to your global stylesheet (e.g., globals.css):
 * See the bottom of this file for the complete CSS rules.
 */
