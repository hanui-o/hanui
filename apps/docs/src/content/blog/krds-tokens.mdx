---
title: "KRDS 디자인 토큰 Tailwind CSS 적용 방법 - 17px 폰트, 색상 시스템"
description: "KRDS의 17px 기본 폰트를 Tailwind CSS에서 처리하는 방법. 숫자 스케일과 시맨틱 토큰을 활용한 색상 시스템, 반응형 타이포그래피 구현."
date: "2025-02-10"
tags: ["KRDS", "Tailwind CSS", "디자인토큰", "CSS변수", "다크모드"]
author: "odada"
---
