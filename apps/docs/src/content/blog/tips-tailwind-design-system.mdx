...
description: 'Tailwind CSS로 색상 토큰, 타이포그래피, 간격 시스템을 설정하고 cva로 타입 안전한 컴포넌트를 만드는 방법. 공공기관은 KRDS 기반 HANUI 프리셋 활용법도 포함.'
date: '2025-01-10'
tags: ['Tailwind CSS', '디자인시스템', 'React', 'CSS변수', 'cva', '프론트엔드']
author: 'odada'
---
