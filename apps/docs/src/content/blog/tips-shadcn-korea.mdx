---
title: 'shadcn/ui 한국 프로젝트에서 제대로 쓰는 법'
description: 'shadcn/ui를 한국 프로젝트에 적용할 때 필요한 한글 폰트, 색상 커스터마이징, DatePicker 한글화, 접근성 설정을 정리합니다.'
date: '2025-01-10'
tags: ['shadcn', 'React', 'TailwindCSS', '한글화', '프론트엔드', '컴포넌트']
author: 'odada'
---
