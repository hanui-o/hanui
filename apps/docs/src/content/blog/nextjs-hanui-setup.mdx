---
title: 'Next.js + HANUI 프로젝트 세팅 가이드'
description: 'Next.js에서 HANUI(KRDS 기반 디자인 시스템)를 세팅하는 방법. npx hanui init 한 줄로 Tailwind, 토큰, 폰트까지 자동 설정.'
date: '2025-02-15'
...
폰트 파일은 [Pretendard GOV](https://github.com/orioncactus/pretendard)에서 다운로드하세요.
...
> **관련 글:**
>
> - [HANUI 컴포넌트 시스템 소개](/blog/hanui-open)
> - [KRDS 디자인 토큰 완전 정복](/blog/krds-tokens)
> - [폼 컴포넌트 구현기](/blog/form-components)
>
> **관련 프로젝트:**
>
