---
title: 'HANUI Kits — 복사해서 바로 쓰는 기능 패턴'
description: '컴포넌트만으론 부족해요. 게시판, 인증, 대시보드 같은 기능을 API URL만 바꾸면 바로 쓸 수 있는 HANUI Kits를 소개합니다.'
date: '2026-02-09'
tags: ['HANUI', 'React', 'Kit', 'KRDS', '디자인시스템']
author: 'odada'
---
...
> - [Kits 문서](https://hanui.io/kits) — 사용 가능한 모든 Kit 목록
