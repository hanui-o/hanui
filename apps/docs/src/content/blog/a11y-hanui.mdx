---
title: "KWCAG 2.2 웹접근성 자동 적용 - KRDS React 컴포넌트로 검수 통과하기"
description: "HANUI 컴포넌트에 내장된 웹접근성 기능. aria 속성, 키보드 네비게이션, 포커스 관리까지 자동 적용되어 KWCAG 2.2 검수를 통과할 수 있습니다."
date: "2025-02-05"
tags: ["KWCAG", "웹접근성", "KRDS", "React", "aria"]
author: "odada"
---
