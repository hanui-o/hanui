---
title: "KRDS React 컴포넌트 라이브러리 HANUI - 그냥 가져다 쓰세요"
description: "KRDS 2.2 표준을 따르는 React 컴포넌트 라이브러리. shadcn/ui 방식으로 소스 코드를 복사해서 자유롭게 수정할 수 있습니다."
date: "2025-01-15"
tags: ["KRDS", "React", "오픈소스", "컴포넌트"]
author: "odada"
---
