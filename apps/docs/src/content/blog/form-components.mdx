---
title: 'KRDS React Form 컴포넌트 - Input, Select, 자동 접근성 연결'
description: 'FormField로 감싸면 label 연결, 에러 메시지, aria 속성이 자동으로 처리됩니다. react-hook-form 연동 예시까지.'
date: '2025-02-12'
tags: ['KRDS', 'React', 'Form', '웹접근성', 'HANUI']
author: 'odada'
---
...
> **HANUI 시리즈:**
>
> - [HANUI 오픈소스 공개](/blog/hanui-open)
> - [shadcn 스타일로 KRDS 만들기](/blog/shadcn-style-krds)
> - [Before/After 비교](/blog/before-after)
> - [Button 딥다이브](/blog/button-deep-dive)
> - [접근성](/blog/a11y-hanui)
> - [KRDS 디자인 토큰](/blog/krds-tokens)
> - **Form 컴포넌트** ← 현재 글
>
> **관련 링크:**
>
> - [HANUI](https://github.com/hanui-o/hanui) — KRDS 기반 React 디자인 시스템
> - [claude-settings](https://github.com/hanui-o/claude-settings) — Claude Code 슬래시 커맨드 모음
