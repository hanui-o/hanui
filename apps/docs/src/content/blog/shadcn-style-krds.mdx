---
title: "shadcn/ui 방식의 KRDS React 컴포넌트 - 왜 npm 패키지가 아닌가"
description: "HANUI가 npm 패키지 대신 shadcn/ui 방식의 소스 복사를 택한 기술적 이유. Tailwind CSS, Radix UI 기반 아키텍처 설명."
date: "2025-01-20"
tags: ["shadcn", "React", "Tailwind CSS", "아키텍처"]
author: "odada"
---
