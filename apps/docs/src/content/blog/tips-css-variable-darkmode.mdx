---
title: 'CSS 변수로 다크모드 구현하기'
description: 'CSS 변수(Custom Properties)를 활용한 다크모드 구현법. 시맨틱 토큰, Tailwind 연동, SSR 깜빡임 방지까지 실전 가이드.'
date: '2025-01-25'
tags: ['CSS', '다크모드', 'CSS변수', 'TailwindCSS', 'React', '프론트엔드']
author: 'odada'
---
...
- [Tailwind CSS 다크모드 공식 문서](https://tailwindcss.com/docs/dark-mode)
