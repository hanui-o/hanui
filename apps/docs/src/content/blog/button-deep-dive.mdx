---
title: "KRDS React Button 컴포넌트 설계 - variant, 접근성, cva 패턴"
description: "HANUI Button 컴포넌트의 설계 철학. 8개 variant, cva 패턴, 접근성(aria-busy, 포커스 링), asChild, 아이콘 지원까지."
date: "2025-01-30"
tags: ["KRDS", "React", "Button", "웹접근성", "cva"]
author: "odada"
---
