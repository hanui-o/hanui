---
title: 'KRDS MegaMenu 완전정복 — 공공 웹사이트 네비게이션 만들기'
description: '공공 웹사이트 헤더 메뉴를 HANUI로 구현하는 법. 웹접근성 키보드 네비게이션, ARIA 속성, 포커스 관리까지 자동 처리되는 MegaMenu 사용법.'
date: '2025-03-05'
...
대부분 `HeaderWithMegaMenu`를 많이 써요.
...
> - [Next.js + HANUI 프로젝트 세팅 가이드](/blog/nextjs-hanui-setup)
> - [HANUI Kits — API + 상태관리까지 묶은 기능 키트](/blog/hanui-kits)
>
> **관련 프로젝트:**
>
