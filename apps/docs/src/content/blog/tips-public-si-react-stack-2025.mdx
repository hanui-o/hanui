---
title: '공공 SI React 기술스택 2025'
description: '2025년 공공기관 React 프로젝트 권장 기술스택. Next.js 15, Tailwind 4, KRDS, Zustand, TanStack Query 등 실전 조합 가이드.'
date: '2025-02-01'
tags: ['React', '공공SI', '기술스택', 'NextJS', 'TailwindCSS', '2025', '프론트엔드']
author: 'odada'
---
...
- [HANUI 설치 가이드](https://hanui.io/guide/installation)
