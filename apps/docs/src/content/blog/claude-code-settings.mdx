...
이걸 정리해서 [claude-settings](https://github.com/hanui-o/claude-settings) 레포로 공개했어요. **원라인 설치로 바로 쓸 수 있습니다.** 실제로 이 커맨드를 사용해서 [CMS 프로젝트를 하루만에 만든 사례](/blog/claude-code-cms-workflow)도 있어요.
