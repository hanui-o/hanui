            ...
            <div className="space-y-3">
              <div className="flex items-start gap-4 p-4 border border-krds-gray-20 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-krds-gray-60">
                    타입 정의 코드를 <Code>src/features/[kit]/types/</Code>에
                    복사
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 border border-krds-gray-20 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-krds-gray-60">
                    React Query 훅을 <Code>src/features/[kit]/hooks/</Code>에
                    복사
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4 p-4 border border-krds-gray-20 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-krds-gray-60">
                    Zustand 스토어를 <Code>src/features/[kit]/store/</Code>에
                    복사
                  </p>
                </div>
              </div>
        ...
        <TabsContent value="test">
          ...
          <Section level="h2">
            ...
            <List className="mt-4">
              ...
              <ListItem>
                <strong>CORS:</strong> DummyJSON은 CORS가 허용되어
                클라이언트에서 직접 호출 가능합니다.
              </ListItem>
              <ListItem>
