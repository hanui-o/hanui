...
import { Pagination, Body, SkipLink } from '@hanui/react';
          ...
          <TabsContent value="overview">
            ...
            <div className="space-y-8">
              <div>
                ...
                />
                <Body>
                  Pagination 컴포넌트는 많은 콘텐츠를 여러 페이지로 나누어
                  표시할 때 사용하는 네비게이션 컴포넌트입니다.
                </Body>
...
/>`}
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <Body>
                      siblingCount로 현재 페이지 양쪽에 표시할 페이지 수를
                      조정할 수 있습니다. 기본값은 1입니다.
                    </Body>
...
/>`}
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <Body>
                      실제 데이터 목록과 함께 사용하는 예제입니다. 페이지 변경
                      시 목록이 업데이트됩니다.
                    </Body>
    ...
    />
              ...
              <div>
                ...
                <div className="mt-2 md:mt-4">
                  <CodeBlock language="bash" code={`hanui add pagination`} />
                </div>
              </div>

              {/* Guidelines */}
              <div>
                <SectionHeading level="h2" id="guidelines" title="Guidelines" />
                ...
                <div className="mt-2 md:mt-4 space-y-4">
                  ...
                  >
                    <ul className="list-disc list-inside space-y-2">
                      ...
                      <li>
                        무한 스크롤이 더 적합한 소셜 미디어 피드 같은 경우는
                        피하세요
                      </li>
                      <li>
                        순서가 중요하지 않은 콘텐츠에는 다른 네비게이션을
                        고려하세요
                      </li>
                      <li>
                        페이지 수가 너무 많으면 (100개 이상) 검색이나 필터
                        기능을 먼저 제공하세요
                      </li>
                    </ul>
                  </GuidelineSection>
                ...
                <div className="mt-2 md:mt-4 space-y-4">
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li>
                        nav 요소를 사용하여 네비게이션 영역임을 명시합니다
                      </li>
                      <li>
                        적절한 button 요소로 모든 상호작용 지점을 구현합니다
                      </li>
                    </ul>
                  </div>

                  <div>
                    <Body weight="bold">스크린 리더 지원</Body>
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li>aria-label로 페이지네이션 영역임을 설명합니다</li>
                      <li>
                        aria-current="page"로 현재 페이지를 명확히 표시합니다
                      </li>
                      <li>각 버튼에 명확한 aria-label을 제공합니다</li>
                      <li>
                        생략 부호(...)는 aria-hidden으로 스크린 리더에서
                        숨깁니다
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    <Body weight="bold">터치 접근성</Body>
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li>
                        모든 버튼은 최소 40px 이상의 터치 영역을 보장합니다
                      </li>
              ...
              <div>
                ...
                <div className="mt-2 md:mt-4 space-y-6">
                  <div className="space-y-2">
                    <SectionHeading
                      level="h3"
                      title="1. 명확한 현재 위치 (Clear Current Position)"
                    />
                    <Body>
                      현재 페이지는 파란색 배경으로 강조되어 사용자가 자신의
                      위치를 쉽게 파악할 수 있습니다.
                    </Body>
                  </div>
                  ...
                  <div className="space-y-2">
                    <SectionHeading
                      level="h3"
                      title="2. 효율적인 탐색 (Efficient Navigation)"
                    />
                    <Body>
                      이전/다음 버튼과 직접 페이지 선택을 모두 제공하여 빠른
                      탐색을 가능하게 합니다. 생략 부호로 많은 페이지도 간결하게
                      표시합니다.
                    </Body>
                  </div>
                  ...
                  <div className="space-y-2">
                    <SectionHeading
                      level="h3"
                      title="3. 예측 가능한 동작 (Predictable Behavior)"
                    />
                    <Body>
                      첫 페이지에서는 이전 버튼이, 마지막 페이지에서는 다음
                      버튼이 비활성화되어 예측 가능한 인터페이스를 제공합니다.
                    </Body>
                  </div>
                  ...
                  <div className="space-y-2">
                    <SectionHeading
                      level="h3"
                      title="4. 유연한 설정 (Flexible Configuration)"
                    />
                    <Body>
                      siblingCount로 표시되는 페이지 수를 조정할 수 있어 다양한
                      화면 크기와 요구사항에 맞출 수 있습니다.
                    </Body>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-2 md:mt-4 space-y-4">
                  <div>
                    ...
                    <Body>
                      페이지 번호를 URL 쿼리 파라미터와 동기화하면 사용자가
                      페이지를 북마크하거나 공유할 수 있습니다.
                    </Body>
                  </div>

                  <div>
                    <Body weight="bold">2. 로딩 상태 표시</Body>
                    <Body>
                      페이지 변경 시 로딩 인디케이터를 표시하여 사용자에게
                      명확한 피드백을 제공하세요.
                    </Body>
                  </div>

                  <div>
                    <Body weight="bold">3. 스크롤 위치 관리</Body>
                    <Body>
                      페이지 변경 시 목록의 상단으로 자동 스크롤하면 사용자
                      경험이 향상됩니다.
                    </Body>
                  </div>

                  <div>
                    <Body weight="bold">4. 반응형 siblingCount</Body>
                    <Body>
                      화면 크기에 따라 siblingCount를 조정하면 모바일에서도
                      깔끔한 레이아웃을 유지할 수 있습니다.
                    </Body>
                  </div>

                  <div>
                    <Body weight="bold">5. 컨텍스트 정보 제공</Body>
                    <Body>
                      &quot;총 500개 항목 중 1-20&quot;과 같은 정보를 함께
                      표시하면 사용자가 전체 맥락을 이해하기 쉽습니다.
                    </Body>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-2 md:mt-4 space-y-4">
                  <div>
                    ...
                    <Body>
                      nav 요소와 button 요소를 사용하여 접근성과 의미 있는 HTML
                      구조를 제공합니다.
                    </Body>
                  </div>

                  <div>
                    <Body weight="bold">2. WCAG 2.1 / KWCAG 2.2 준수</Body>
                    <Body>
                      aria-label, aria-current 속성을 통해 웹 접근성 표준을
                      준수합니다.
                    </Body>
                  </div>

                  <div>
                    <Body weight="bold">3. 스크린 리더 지원</Body>
                    <Body>
                      각 버튼에 명확한 레이블을 제공하고, 현재 페이지를
                      aria-current로 표시하여 스크린 리더 사용자가 현재 위치를
                      파악할 수 있습니다.
                    </Body>
                  </div>

                  <div>
                    <Body weight="bold">4. 키보드 네비게이션</Body>
                    <Body>
                      Tab 키로 모든 버튼에 접근 가능하며, Enter/Space 키로
                      페이지를 변경할 수 있습니다. 포커스 상태가 명확하게
                      표시됩니다.
                    </Body>
                  </div>

                  <div>
                    <Body weight="bold">5. 다크 모드</Body>
                    <Body>
                      버튼, 텍스트, 배경색이 자동으로 다크 모드에 최적화되어
                      표시됩니다.
                    </Body>
                  </div>
                </div>
          ...
          <TabsContent value="api">
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="mt-2 md:mt-4 space-y-6">
                  <div className="space-y-2">
                    <SectionHeading level="h3" title="Pagination" />
