      ...
      <Tabs defaultValue="overview">
        ...
        <TabsContent value="overview">
          ...
          <Section>
            ...
            <Subsection level="h3">
              <SectionHeading level="h3" title="표준 스케일 표" />
          ...
          <Section>
            ...
            <Subsection level="h3">
              <SectionHeading level="h3" title="계산 공식" />
            ...
            <Subsection level="h3">
              <SectionHeading level="h3" title="계산 시 주의 사항" />
            ...
            <Subsection level="h3">
              <SectionHeading level="h3" title="계산 예시" />
          ...
          <Section>
            ...
            <Subsection level="h3">
              <SectionHeading level="h3" title="radius 비율 적용 방법" />
            ...
            <Subsection level="h3">
              <SectionHeading level="h3" title="주의 사항" />
          ...
          <Section>
            ...
            <Subsection level="h3">
              <SectionHeading level="h3" title="px 값 사용">
...
<div className="rounded-lg">Card</div>`}
            ...
            <Subsection level="h3">
              <SectionHeading level="h3" title="% 값 사용">
                <Body className="leading-relaxed">
...
<div className="rounded-[50%]">Circle</div>`}
            ...
            <Subsection level="h3">
              <SectionHeading level="h3" title="% 설정 시 주의 사항" />
...
<button className="h-10 rounded-md">Button</button>`}
        ...
        <TabsContent value="api">
          ...
          <Section>
            ...
            <Subsection level="h3">
              <SectionHeading level="h3" title="표준형 Tailwind Classes" />
            ...
            <Subsection level="h3">
              <SectionHeading level="h3" title="특수 Classes" />
            ...
            <Subsection level="h3">
              <SectionHeading level="h3" title="방향별 Classes" />
