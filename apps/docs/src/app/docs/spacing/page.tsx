...
import { PageNavigation, PageSection, Heading } from '@/components/content';
        ...
        <TabsContent value="overview">
          ...
          <PageSection>
            <Heading
              ...
              title="Heading 컴포넌트 사용법"
              description="Heading는 PageSection 내부에서 사용하는 제목과 설명을 일관되게 표시하는 컴포넌트입니다. 레벨별로 자동으로 적절한 간격과 margin-bottom이 적용됩니다."
            />
    ...
    커스텀 내용 <strong>강조</strong> 가능
              ...
              <div className="bg-krds-primary-5 border border-krds-primary-20 rounded-lg p-4">
                <Body size="sm">
                  ...
                  경우 항상 Heading를 사용하세요. 레벨별로 자동으로 적절한
            ...
            <PageSection>
              ...
              <Stack gap="md">
                <Card variant="outlined">
                  <Heading level="h4" title="1. 8px 기반 배수 사용">
...
<div className="gap-3 p-5 mb-7"> // 불규칙한 값`}
                ...
                <Card variant="outlined">
                  <Heading level="h4" title="2. 시맨틱 컴포넌트 우선">
                    <Body size="sm" className="text-krds-gray-70">
...
<div className="flex flex-col gap-4">
  ...
  <Input />
                ...
                <Card variant="outlined">
                  <Heading level="h4" title="3. 일관된 패딩 프리셋 사용">
                    <Body size="sm" className="text-krds-gray-70">
...
<div className="p-6 md:p-8">
  Content
                ...
                <Card variant="outlined">
                  <Heading level="h4" title="4. 반응형 간격은 명확한 의도로">
                    <Body size="sm" className="text-krds-gray-70">
