        ...
        <Subsection level="h3">
          ...
          <div className="bg-krds-gray-5 rounded-lg p-6 border border-krds-gray-20">
            <ul className="space-y-3 text-krds-gray-90">
              <li className="flex items-start gap-3">
                <span className="text-krds-gray-70 font-bold mt-0.5">✓</span>
                <div>
                  <strong>접근성 자동 보장:</strong> WCAG 2.1 AA 기준을 자동으로
                  준수합니다. ARIA 속성, 키보드 네비게이션, 포커스 관리 등
                  복잡한 접근성 로직을 Radix가 자동으로 처리합니다.
                </div>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-krds-gray-70 font-bold mt-0.5">✓</span>
          ...
          <div className="bg-krds-gray-5 rounded-lg p-6 border border-krds-gray-20 ">
            <ul className="space-y-3 text-krds-gray-90">
              <li className="flex items-start gap-3">
                <span className="text-krds-gray-70 font-bold mt-0.5">✓</span>
                <div>
                  <strong>완전한 소유권:</strong> 컴포넌트 소스 코드가
                  프로젝트에 복사되므로, 라이브러리 업데이트에 영향받지 않고
                  안정적으로 사용할 수 있습니다. 필요에 따라 자유롭게 수정할 수
                  있습니다.
                </div>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-krds-gray-70 font-bold mt-0.5">✓</span>
                <div>
                  <strong>유지보수 용이성:</strong> 컴포넌트 코드를 직접
                  확인하고 수정할 수 있어, 버그 수정이나 기능 추가가 즉시
                  가능합니다. 외부 라이브러리 의존성 문제 없이 프로젝트를 완전히
                  제어할 수 있습니다.
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  준수하면서도 프로젝트의 특수한 요구사항에 맞게 컴포넌트를
                  수정할 수 있습니다. 번들 크기도 필요한 컴포넌트만 포함하여
                  최적화할 수 있습니다.
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  코드를 통해 Radix UI와 접근성 구현 방법을 학습할 수 있습니다.
                  팀 내부 지식 공유에도 유용합니다.
                </div>
              </li>
            </ul>
        ...
        <Subsection level="h3">
          <SectionHeading level="h3" title="Tailwind CSS">
            <Body className="leading-relaxed">
              ...
              수 있습니다. Radix UI의{' '}
              <code className="bg-krds-gray-5 px-1 rounded">data-[state]</code>{' '}
              속성과 함께 사용하여 상태 기반 스타일링도 쉽게 구현할 수 있습니다.
            </Body>
          </SectionHeading>
        </Subsection>
      </Section>
