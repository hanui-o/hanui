  ...
  return (
    <>
      ...
      <PageSection>
        ...
        <div className="bg-krds-gray-5 rounded-lg p-6 border border-krds-gray-20 mt-4">
        ...
        <SectionHeading level="h3" title="소스 코드 기반 배포">
          <Body className="leading-relaxed">
            HANUI는 <strong>소스 코드 복사 방식</strong>으로 배포되어, 사용자가
            컴포넌트를 직접 수정하고 커스터마이징할 수 있습니다.
          </Body>
        </SectionHeading>
        <div className="bg-krds-gray-5 rounded-lg p-6 border border-krds-gray-20 mt-4">
          <ul className="space-y-3 text-sm text-krds-gray-90">
        ...
        <SectionHeading level="h3" title="Tailwind CSS">
          <Body className="leading-relaxed">
            유틸리티 클래스 기반으로 컴포넌트를 쉽게 커스터마이징할 수 있습니다.
            프로젝트의 디자인 시스템에 맞게 자유롭게 스타일을 조정할 수
            있습니다. Radix UI의{' '}
      ...
      {/* Browser Support */}
      <PageSection>
        <SectionHeading level="h2" id="browser-support" title="브라우저 지원" />
