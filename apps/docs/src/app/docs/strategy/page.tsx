import { Typography } from '@hanui/react';
        ...
        <div className="space-y-8">
          <div>
            ...
            <ul className="ml-6 mb-4 space-y-2 list-disc">
              ...
              <li>
                <Typography variant="body1">EU → EU Design System</Typography>
              </li>
              <li>
                <Typography variant="body1">
              ...
              <li>
                <Typography variant="body1">호주 → AU Design System</Typography>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="ml-6 mb-4 space-y-2 list-disc">
              <li>
                <Typography variant="body1">표준화된 디자인</Typography>
              </li>
              <li>
                <Typography variant="body1">접근성(A11y) 준수</Typography>
              </li>
              <li>
                <Typography variant="body1">컴포넌트 규격화</Typography>
              </li>
              <li>
                <Typography variant="body1">빠른 구축 가능</Typography>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="ml-6 space-y-2 list-disc">
              <li>
                <Typography variant="body1">공공기관 웹사이트 빌더</Typography>
              </li>
              <li>
                <Typography variant="body1">교육기관 템플릿</Typography>
              </li>
              <li>
                <Typography variant="body1">NGO/시민단체 사이트</Typography>
              </li>
              <li>
                <Typography variant="body1">글로벌 공공 SaaS 플랫폼</Typography>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="ml-6 mb-4">
              ...
              <ul className="space-y-2 list-disc ml-6">
                ...
                <li>
                  <Typography variant="body1">명확한 포커스 표시</Typography>
                </li>
                <li>
                  <Typography variant="body1">색약/색맹 배려</Typography>
                </li>
                <li>
                  <Typography variant="body1">
                    동작·플래시 위험 요소 제거
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <ul className="ml-6 space-y-1 list-disc">
                  ...
                  <li>
                    <Typography variant="body1">제목 읽기</Typography>
                  </li>
                  <li>
                    <Typography variant="body1">설명 읽기</Typography>
                  </li>
                  <li>
                    <Typography variant="body1">버튼 구조 정보 제공</Typography>
                  </li>
                </ul>
